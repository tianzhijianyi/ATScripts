...
class EmailHandler(object):
    ...
    def send_email(self):
        ...
        mail_user = "2516183675@qq.com"  # 用户名
        # mail_pass = "tfmudibvlpscebbj"  # 口令

        # 设置收件人和发件人
        sender = '2516183675@qq.com'
        receivers = ['2516183675@qq.com', 'tingyuweilou@163.com', '3300799899@qq.com']  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
